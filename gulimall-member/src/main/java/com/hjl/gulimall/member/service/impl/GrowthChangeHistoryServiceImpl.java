...
import com.hjl.gulimall.member.dao.GrowthChangeHistoryDao;
import com.hjl.gulimall.member.entity.GrowthChangeHistoryEntity;
import com.hjl.gulimall.member.service.GrowthChangeHistoryService;
...
public class GrowthChangeHistoryServiceImpl extends ServiceImpl<GrowthChangeHistoryDao, GrowthChangeHistoryEntity>
    ...
    public PageUtils queryPage(Map<String, Object> params) {
        IPage<GrowthChangeHistoryEntity> page = this.page(new Query<GrowthChangeHistoryEntity>().getPage(params),
