...
import com.hjl.gulimall.coupon.dao.HomeSubjectSpuDao;
import com.hjl.gulimall.coupon.entity.HomeSubjectSpuEntity;
import com.hjl.gulimall.coupon.service.HomeSubjectSpuService;
...
public class HomeSubjectSpuServiceImpl extends ServiceImpl<HomeSubjectSpuDao, HomeSubjectSpuEntity>
    ...
    public PageUtils queryPage(Map<String, Object> params) {
        IPage<HomeSubjectSpuEntity> page = this.page(new Query<HomeSubjectSpuEntity>().getPage(params),
