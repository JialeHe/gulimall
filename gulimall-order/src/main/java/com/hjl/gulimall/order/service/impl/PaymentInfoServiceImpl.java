...
import com.hjl.gulimall.order.dao.PaymentInfoDao;
import com.hjl.gulimall.order.entity.PaymentInfoEntity;
import com.hjl.gulimall.order.service.PaymentInfoService;
...
public class PaymentInfoServiceImpl extends ServiceImpl<PaymentInfoDao, PaymentInfoEntity>
    ...
    public PageUtils queryPage(Map<String, Object> params) {
        IPage<PaymentInfoEntity> page = this.page(new Query<PaymentInfoEntity>().getPage(params),
