...
import com.hjl.gulimall.order.dao.OrderReturnApplyDao;
import com.hjl.gulimall.order.entity.OrderReturnApplyEntity;
import com.hjl.gulimall.order.service.OrderReturnApplyService;
...
public class OrderReturnApplyServiceImpl extends ServiceImpl<OrderReturnApplyDao, OrderReturnApplyEntity>
    ...
    public PageUtils queryPage(Map<String, Object> params) {
        IPage<OrderReturnApplyEntity> page = this.page(new Query<OrderReturnApplyEntity>().getPage(params),
